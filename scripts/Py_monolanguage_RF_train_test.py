"""
Script Huấn Luyện và Kiểm Tra Random Forest Đơn Ngôn Ngữ Python
Huấn luyện mô hình phân loại Random Forest chỉ trên các gói PyPI (Python)
...
def main():
    """
    Hàm chính để huấn luyện và đánh giá Random Forest trên các gói PyPI
    """
    print("=" * 80)
    print("HUẤN LUYỆN VÀ KIỂM TRA RANDOM FOREST ĐƠN NGÔN NGỮ PYTHON")
    print("=" * 80)
    print()
    ...
    print("\n" + "=" * 80)
    print("HUẤN LUYỆN RANDOM FOREST VỚI BAYESIAN OPTIMIZATION")
    print("=" * 80)
    print()
    ...
    print(f"✓ Đang huấn luyện Random Forest trên toàn bộ tập dữ liệu ({len(X)} mẫu)...")
    ...
    feature_names = data.drop(labels=['Package Repository', 'Malicious', 'Package Name'], axis=1).columns
    ...
    joblib_file = os.path.join(models_dir, f'Py_Monolanguage_RF_{dt}.pkl')
    
    print(f"✓ Đang lưu mô hình vào: {joblib_file}")
