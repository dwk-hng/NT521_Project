"""
Script Huấn Luyện và Kiểm Tra XGBoost Đơn Ngôn Ngữ Python
Huấn luyện mô hình phân loại XGBoost chỉ trên các gói PyPI (Python)
...
def main():
    """
    Hàm chính để huấn luyện và đánh giá XGBoost trên các gói PyPI
    """
    print("=" * 80)
    print("HUẤN LUYỆN VÀ KIỂM TRA XGBOOST ĐƠN NGÔN NGỮ PYTHON")
    print("=" * 80)
    print()
    ...
    joblib_file = os.path.join(models_dir, f'Py_Monolanguage_XGBoost_{dt}.pkl')
